...
parser.add_argument('--input_folder', type=str, default='F:\\ayejiantuxiangronghe\diguangtuxiangronghe\colie-main\colie-main\input\\00881N.png')
parser.add_argument('--output_folder', type=str, default='F:\\ayejiantuxiangronghe\diguangtuxiangronghe\colie-main\colie-main\input\\00881N.png')
